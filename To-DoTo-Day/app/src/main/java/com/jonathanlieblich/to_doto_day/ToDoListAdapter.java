...
public class ToDoListAdapter extends RecyclerView.Adapter<ToDoListViewHolder> {
    ...
    public void onBindViewHolder(final ToDoListViewHolder holder, final int position) {
        ...
        holder.mEditButton.setContentDescription("Edit or view contents of "+newList.getListTitle());
        holder.mDeleteButton.setContentDescription("Delete list named "+newList.getListTitle());
